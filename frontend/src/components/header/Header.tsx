...
export default function Header() {
    ...
    return (
        <header className="px-5 py-3 border-b-2 border-black dark:border-white text-black dark:text-white">
            <div className="flex flex-row place-content-between items-center">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <button onClick={() => setSettingsOpen(true)}>
                        <svg className="w-6 h-6 fill-black dark:fill-white hover:opacity-70" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
